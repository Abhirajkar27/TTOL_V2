        ...
        <div className='truthIPPage'>
            ...
            <div className='topsmallcards'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 47" fill="none">
                    ...
                    {canMove && <div className='tick-onfirst'><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <rect  rx="7" fill="#161716" fill-opacity="0.1" />
