...
const TruthIp = (props) => {
    ...
    return (
        <div className='truthIPPage'>
            ...
            {canMove && <svg className='tick_svg' xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
...
{canMove && <svg className='tick_svg2' xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
  <rect width="14" height="14" rx="7" fill="#161716" fill-opacity="0.1"/>
  <path d="M4 7L6 9L10 5" stroke="#161716" stroke-opacity="0.8" stroke-linecap="round" stroke-linejoin="round"/>
</svg>}
{canMove && <svg className='tick_svg3' xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
  <rect width="14" height="14" rx="7" fill="#161716" fill-opacity="0.1"/>
  <path d="M4 7L6 9L10 5" stroke="#161716" stroke-opacity="0.8" stroke-linecap="round" stroke-linejoin="round"/>
</svg>}
