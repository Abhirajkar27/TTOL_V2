    ...
    return (
        <div className='truthIPPage'>
            ...
            <div className='topsmallcards'>
                {<svg className='tick_svg' xmlns="http://www.w3.org/2000/svg" width="14" visibility={canMove ? "" : "hidden"} height="14" viewBox="0 0 14 14" fill="none">
                ...
                {<svg className='tick_svg2' xmlns="http://www.w3.org/2000/svg" width="14" visibility={canMove ? "" : "hidden"} height="14" viewBox="0 0 14 14" fill="none">
                    <rect width="14" height="14" rx="7" fill="#161716" fill-opacity="0.1" />
                    <path d="M4 7L6 9L10 5" stroke="#161716" stroke-opacity="0.8" stroke-linecap="round" stroke-linejoin="round" />
                </svg>}
                {<svg className='tick_svg3' xmlns="http://www.w3.org/2000/svg" width="14" visibility={canMove ? "" : "hidden"} height="14" viewBox="0 0 14 14" fill="none">
                    <rect width="14" height="14" rx="7" fill="#161716" fill-opacity="0.1" />
                    <path d="M4 7L6 9L10 5" stroke="#161716" stroke-opacity="0.8" stroke-linecap="round" stroke-linejoin="round" />
                </svg>}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 47" fill="none">
                    <rect y="11.9526" width="23" height="36" rx="3" transform="rotate(-15 0 11.9526)" fill={`${canMove ? "#02FF89" : "#526175"}`}>
                    </rect>
