      ...
      <div className="crd-stk">
        ...
        <div className='Card_Truth_Lie'>
          ...
          <div className='Card_options'>
            {tarr.map((element) => <Truth_Options text={element} />)}
          </div>
          <button className='Card_next_button'> <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
